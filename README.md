...
Antora-based documentation component for the ownCloud iOS mobile app. This repository contains the AsciiDoc source files for the iOS client user documentation, built as part of the [main docs site](https://github.com/owncloud/docs) and published to [doc.owncloud.com](https://doc.owncloud.com).
...
This is a content component for the [ownCloud docs](https://github.com/owncloud/docs) Antora build. The iOS app source code lives at [owncloud/ios-app](https://github.com/owncloud/ios-app). Published documentation is available at [doc.owncloud.com](https://doc.owncloud.com).

## Community & Support

**[Star](https://github.com/owncloud/docs-client-ios-app)** this repo and **Watch** for release notifications!
