...
^| image:file-actions.jpg[File actions dialog for individual files in ownCloud's iOS App., width=45%,pdfwidth=45%]
^| image:file-actions-multiple-files-selected.png[File actions dialog for multiple-selected files in ownCloud's iOS App., width=45%,pdfwidth=45%]
|===
...
image:21_File_list_parent.png[Navigating folders in ownCloud's iOS app, width=60%,pdfwidth=60%]
...
image:index-bar-with-callout.png[Navigating files in ownCloud's iOS app, width=60%,pdfwidth=60%]
...
^| image:sort-files-portrait-mode.png[Sorting files and folders in portrait mode, width=45%,pdfwidth=45%]
^| image:sort-files-landscape-mode.png[Sorting files and folders in landscape mode, width=45%,pdfwidth=45%]
|===
...
image:icon-not-available-locally.png[alt=A file is not downloaded locally on the ownCloud iOS app, width=60%,pdfwidth=60%]
next to the file. When you click on it, you will see
image:icon-download.png[alt=A file is downloading on the ownCloud iOS app, width=60%,pdfwidth=60%]
...
a|
.An image file
image:view-file-image.png[Viewing an image file in the ownCloud iOS App, width=45%,pdfwidth=45%]
a|
.A video file
image:view-file-video.png[Viewing a video file in the ownCloud iOS App, width=45%,pdfwidth=45%]
a|
.A PDF file
image:view-file-pdf.png[Viewing a PDF file in the ownCloud iOS App, width=45%,pdfwidth=45%]
a|
.A text file
image:view-file-text-file.png[Viewing a text file in the ownCloud iOS App, width=45%,pdfwidth=45%]
a|
.An ODT file.
image:view-file-odt.png[Viewing an ODT file in the ownCloud iOS App, width=45%,pdfwidth=45%]
|
|===
...
a|
.A page selector
image:41_PDF.png[Page selector in PDF files in the ownCloud iOS App, width=45%,pdfwidth=45%]
a|
.A table of contents
image:42_PDF_toc.png[Table of contents in PDF files in the ownCloud iOS App, width=45%,pdfwidth=45%]
a|
.Page thumbnails
image:43_PDF_thumbs.png[Page thumbnails in PDF files in the ownCloud iOS App, width=45%,pdfwidth=45%]
a|
.File search
image:44_PDF_search.png[File search in PDF files in the ownCloud iOS App, width=45%,pdfwidth=45%]
a|
|===
...
image:directory-actions.png[Folder actions in ownCloud's iOS App., width=60%,pdfwidth=60%]
...
image:create-new-folder.png[How to create a new folder in ownCloud's iOS App., width=60%,pdfwidth=60%]
...
image:24_Upload_Photo_multi.png[Upload one or more photos from your Photo Library with the ownCloud iOS App., width=60%,pdfwidth=60%]
...
image:26_Files_multidragdrop.png[Move multiple files (and folders) to another location in the ownCloud iOS App., width=60%,pdfwidth=60%]
...
image:file-with-same-name-already-exists.png[ownCloud iOS App, file or folder with the same name already exists in the destination directory., width=60%,pdfwidth=60%]
====
...
image:26_Files_multidragdrop_iPad.png[Drag and Drop Files Between Apps (iPad-only) in ownCloud's iOS App., width=60%,pdfwidth=60%]
