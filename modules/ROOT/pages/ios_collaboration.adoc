...
image:31_Collab.png[Collaborate With Other Users on Folders and Files, width=60%,pdfwidth=60%]
...
image:manage-public-link-settings.png[Manage public links in ownCloud's Mobile App for iOS, width=60%,pdfwidth=60%]
...
image:public-link-set-password.png[Set a password for a public link in ownCloud's Mobile App for iOS, width=60%,pdfwidth=60%]
...
image:public-link-set-expiration-date.png[Set an expiration date for a public link in ownCloud's MobileApp for iOS, width=60%,pdfwidth=60%]
...
. When viewing the list of links for a file or folder, swipe left on the link that you want to delete,
  ...
  image:swipe-and-delete-public-link.png[, width=60%,pdfwidth=60%]
. When viewing the Public Link, click btn:[Delete] at the bottom of the page, under btn:[Copy Public Link]. +
  image:delete-public-link.png[Delete a Public Link in ownCloud’s iOS app, by clicking Delete at the bottom of the Public Link details page, width=60%,pdfwidth=60%]
