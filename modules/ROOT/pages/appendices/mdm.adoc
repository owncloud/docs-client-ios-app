...
include::./mdm_tables.adoc[tag=oidc]
...
include::./mdm_tables.adoc[tag=account]

=== Authentication Settings

Authentication settings control the behaviour of the web-based login.

include::./mdm_tables.adoc[tag=authentication]
...
include::./mdm_tables.adoc[tag=browsersession]

=== Branding Parameters

include::./mdm_tables.adoc[tag=branding]
...
include::./mdm_tables.adoc[tag=diagnostics]
...
include::./mdm_tables.adoc[tag=licensing]

=== Localization feature

The localization feature allows to overwrite every string in the app, in every language.

include::./mdm_tables.adoc[tag=localization]

=== Privacy ???

Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus orci lorem, sagittis at mollis non, consequat a purus. Integer vestibulum luctus est id faucibus. Etiam euismod posuere tristique.

include::./mdm_tables.adoc[tag=privacy]

=== Releasenotes

include::./mdm_tables.adoc[tag=releasenotes]
