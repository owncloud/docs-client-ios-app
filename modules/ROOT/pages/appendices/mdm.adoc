...
:toc: right
:ios-mdm-tables-url: https://raw.githubusercontent.com/owncloud/ios-app/{ios-branch}/docs/modules/ROOT/pages/ios_mdm_tables.adoc
// :ios-mdm-tables-url: https://raw.githubusercontent.com/owncloud/ios-app/{ios-branch}/doc/antora/pages/ios_mdm_tables.adoc
...
include::{ios-mdm-tables-url}[tag=app]
...
include::{ios-mdm-tables-url}[tag=actions]
...
// include::{ios-mdm-tables-url}[tag=displaysettings]
...
include::{ios-mdm-tables-url}[tag=passcode]
...
include::{ios-mdm-tables-url}[tag=shortcuts]
////
...
include::{ios-mdm-tables-url}[tag=logging]
