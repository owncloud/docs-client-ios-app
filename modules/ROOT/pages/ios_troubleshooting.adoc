...
image:ios-app-settings-logging.png[ios-app-settings-logging,, width=40%,pdfwidth=40%]
...
image:owncloud-log-configuration.png[Configuring logging in ownCloud server., width=40%,pdfwidth=40%]
...
image:mitmproxy_screenshot.png[mitmproxy sample output, width=100%,pdfwidth=100%]
