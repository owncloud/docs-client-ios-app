...
image:ios-app-settings-logging.png[ios-app-settings-logging,, width=60%,pdfwidth=60%]
...
image:owncloud-log-configuration.png[Configuring logging in ownCloud server., width=60%,pdfwidth=60%]
...
image:mitmproxy_screenshot.png[mitmproxy sample output, width=60%,pdfwidth=60%]
